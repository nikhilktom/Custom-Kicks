...
function MenuAction({ setAiTexture }) {
    ...
    return (
        <>
            ...
            {isAskModal &&
                <div className="fixed overflow-hidden w-full h-full left-0 top-0 bg-blue-600 bg-opacity-50 flex justify-center items-center">
                    {isThinking ?
                        <PreloadSVG />
                        :
                        <div className="relative w-[600px] h-[300px] bg-white rounded-xl p-4">
                            ...
                            <button
                                className="px-3 absolute right-2 top-2 text-xl text-white bg-blue-600 border-2 border-blue-600 rounded-md transition-colors hover:bg-white hover:text-blue-600"
                            ...
                            <textarea
                                className="w-full border-4 h-[180px] outline-none"
                            ...
                            <button
                                className="px-8 py-2 mt-2 text-xl font-bold text-white bg-blue-600 border-2 border-blue-600 rounded-lg block mx-auto hover:bg-white hover:text-blue-600"
